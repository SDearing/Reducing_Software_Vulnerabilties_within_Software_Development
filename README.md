...
In the questionnaire I ask the participant what, in their opinion, is their understanding of software vulnerabilities. There answer to this question will be compared to the questions about software vulnerabilities to see if they are correct in their opinion or if their understanding is not as well as they think. This question is important as it allows me to see if participants truly understand software vulnerablities, and are not just putting a high score due to demand characteristics. Demand characteristics are when a participant in a study alters their true answer to a more desirable one.
### Table of Results
...
From comparing these two graphs I can tell that most of the participants answered gave themselve a suitable ranking for their knowledge of software vulnerabilities; with about 12 out of the 20 participants giving themselves a suitable rank. However in such cases like participant 16 you can see that some participants over scored themselves according to how many questions they answered correctly. Due to this analysis I can infer that some participants were not aware of how accurate their knowledge of software vulnerablities were.
...
Another conclusion I can make from the analysis of my second question is that a majority of students practise using secure passwords for their accounts. With most students not using the same password for accounts and having no personal information within their passwords.

Another conclusion I can make is that a majority of students do not have a great understanding of software vulnerabilties, I can conclude this because 70% of the students that took my survey could not answer any questions involving vulnerabilities in software. This suggests that students are not taught about software vulnerabilties and therefore will not know when they are dealing with faulty software.

Another conclusion made from my case studies is that using third-party software can be extremely risky. Like I saw in the Equifax case study, third-party software which may seem to be reliable, may have undiscovered huge flaws that could create a huge vulnerability to any system using it. For this reason, if third-party software is being used, it should be tested thoroughly by the company using it to ensure it has no huge unseen flaws that could break the system you are trying to implement it in.
## Reflection of The Value of Undertaking This Research
The research that I conducted proved to be very valuable as it helped me reach my project's aims and objectives. The conclusions that I drawed from my conclusions allowed to me to create a more secure software during development as I knew what vulnerabilties to look out for. However if I was to conduct my primary research there would be some improvements I would make. One improvement I would make is to increase the sample size, this is so I could improve the reliability of my results, as I only used 20 participants there is a chance that if gave my survey to a larger sample size my results would change. Another thing I would change about my primary research is my sampling method. In my primary research I used random sampling to ensure that there was no bias in my participant selection. However, upon further inspection of my research subject matter, I feel like it would of been more beneficial to use stratified sampling to make sure that I would have an equal amount of participants that were programmers and participants that were not programmers to act as the normal.
